...
RiderSaarthi AI is a **mobile-first AI-powered parametric insurance platform** designed for Swiggy/Zomato delivery partners in Hyderabad.  
...
Build an **interactive frontend prototype** demonstrating:
- Subscription plans
- Claim triggering flow
- Payout simulation
- Fraud / Flagged claim concept

_No backend, login/authentication, or real AI integration yet._
...
Phase 1 shows **simulation only**. Key concepts:
- Detect unusual claim patterns  
- Check multiple claims from same zone in short time  
...
---
Open your browser at the port shown in the terminal (default: http://localhost:5173).
...
Demonstrates project & persona

Scrolls through README

Shows interactive prototype flow
